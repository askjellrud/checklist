...
export const Flex = React.forwardRef<HTMLDivElement, FlexProps>(({
  ...
  const allClassNames = classNames(
    ...
    padding4 && styles.padding4,
    padding8 && styles.padding8,
    padding16 && styles.padding16,
    padding32 && styles.padding32,
    paddingBottom4 && styles.paddingBottom4,
    paddingBottom8 && styles.paddingBottom8,
    paddingBottom16 && styles.paddingBottom16,
    paddingBottom24 && styles.paddingBottom24,
    paddingBottom32 && styles.paddingBottom32,
    paddingLeft4 && styles.paddingLeft4,
    paddingLeft8 && styles.paddingLeft8,
    paddingLeft16 && styles.paddingLeft16,
    paddingLeftRight16 && styles.paddingLeftRight16,
    paddingLeftRight24 && styles.paddingLeftRight24,
    paddingRight4 && styles.paddingRight4,
    paddingRight8 && styles.paddingRight8,
    paddingRight16 && styles.paddingRight16,
    paddingRight24 && styles.paddingRight24,
    paddingTop4 && styles.paddingTop4,
    paddingTop8 && styles.paddingTop8,
    paddingTop16 && styles.paddingTop16,
